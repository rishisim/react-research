"""
SciFACT Experiment Runner with Continuation System
...
from scifact_utils import WEBTHINK_PROMPT_TEMPLATE
from react_agent import run_react
from nexus_wrapper import run_nexus


class SciFACTExperimentRunner:
    ...
    def __init__(
        ...
        results_base_dir: str = "../../../results/scifact",
        seed: int = 888,
        ...
        Args:
            ...
            num_examples: Number of SciFACT examples to run
        ...
        self.max_scifact_dev_examples = 300  # SciFACT dev set size
        ...
        print("="*70, flush=True)
        print(f"[EXPERIMENT] SciFACT Agent Evaluation", flush=True)
        print("="*70, flush=True)
    ...
    def _load_or_create_config(self) -> Dict:
        ...
        if self.config_path.exists():
            ...
            config = {
                "seed": self.seed,
                "model": self.model,
                "max_scifact_dev_examples": self.max_scifact_dev_examples,
    ...
    def select_indices(self) -> List[int]:
        ...
        all_indices = list(range(self.max_scifact_dev_examples))
        ...
        print(f"\n[INDICES] Total available: {self.max_scifact_dev_examples}")
    ...
    def run_framework(self, framework: str, idx: int) -> Dict[str, Any]:
        """
        Run a specific framework on a claim index.
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run SciFACT experiments with continuation support")
    ...
    runner = SciFACTExperimentRunner(
        model=args.model,
