"""
ReAct Agent for SciFACT

Standard single-trace ReAct agent for scientific claim verification.
...
def run_react(idx, prompt_template=None, to_print=True):
    ...
    Returns:
        ...
        - info_dict: Dictionary with keys:
            - question_idx: Index of the claim
            - question_text: The claim text
            - answer: Agent's answer (SUPPORT/REFUTE/NOT ENOUGH INFO)
            - gt_answer: Ground truth answer
            - em: Exact match score
            - f1: F1 score (same as EM for SciFACT)
            - reward: Same as EM
    ...
    info_dict = {
        ...
        'f1': trace_info.get('em', 0.0),  # For SciFACT, F1 = EM
        'reward': reward,
