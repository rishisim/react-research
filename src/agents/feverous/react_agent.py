"""
ReAct Agent for FEVEROUS

Standard single-trace ReAct agent for fact verification with table support.
...
def run_react(idx, prompt_template=None, to_print=True):
    ...
    Returns:
        ...
        - info_dict: Dictionary with keys:
            ...
            - f1: F1 score (same as EM for FEVEROUS)
            - reward: Same as EM
    ...
    if to_print:
        print("="*60)
        print("[FRAMEWORK] FEVEROUS ReAct (Single Trace with Table Support)")
        print("="*60)
    ...
    info_dict = {
        ...
        'f1': trace_info.get('em', 0.0),  # For FEVEROUS, F1 = EM
        'reward': reward,
...
if __name__ == '__main__':
    ...
    print("\n[TEST] Running FEVEROUS ReAct agent test\n")
