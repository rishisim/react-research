...
def run_batch():
    ...
    output_dir = 'results/fever/prog_CA_pruning/react_sample_10_tuned_v6'
    ...
    print(f"Running {len(task_ids)} tasks with Base Prompt + Aggressive Pruning...")
    ...
    for i, idx in enumerate(task_ids):
        ...
        try:
            ...
            result_entry = {
                ...
                'traj': info.get('traj'),
                'pruned_actions': info.get('pruning', {}).get('action_pruning', {}).get('total_pruned', 0),
                'evidence_items': info.get('pruning', {}).get('context_pruning', {}).get('evidence_items', 0)
            }
        ...
        with open(csv_path, 'w', newline='') as output_file:
            ...
            for entry in results:
                ...
                row = {
                    ...
                    'pruned_actions': entry.get('pruned_actions'),
